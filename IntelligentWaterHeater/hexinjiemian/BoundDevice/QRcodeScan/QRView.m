...
- (void)initQRLine {
    ...
    qrLine  = [[UIImageView alloc] initWithFrame:CGRectMake((mScreen.width - 220)/2, 110 , 220, 1)];
...
-(void)animation1
{
    ...
    if (upOrdown == NO) {
        num ++;
        qrLine.frame = CGRectMake((mScreen.width - 220)/2, 110+2*num, 220, 1);
        if (2*num == 200) {
            upOrdown = YES;
        }
    }
...
- (void)drawRect:(CGRect)rect {
    ...
    //中间清空的矩形框
    CGRect clearDrawRect = CGRectMake((mScreen.width - 220)/2, 110, 220, 220);
